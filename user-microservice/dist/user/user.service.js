...
let UserService = class UserService {
    ...
    async signin(req, userDto, res) {
        try {
            ...
            const token = await this.generateJwt(checkUser.image, checkUser.userId, checkUser.name, checkUser.email, checkUser.role);
    ...
    generateJwt(image, userId, name, email, role) {
